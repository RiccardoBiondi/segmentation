...
To achieve this purpose the presented approach will use an algorithm to isolate the lung regions and one to label the different lung areeas.
...
|[method](./docs/CTLungSeg/method.md)| method to apply morphologicla, thresholding and statistical operation on stack of images|
...
```powershell
> ./slice_and_ROI.ps1 path/to/input/folder/ path/to/output/folder/centroids
```
